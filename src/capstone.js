        ...
        <div className='stuff'>
            ...
            <main>
                <div className="nintendo">
                    ...
                    <img src="/imgs/home.png" className="score"/>
                    ...
                    <div className="container">
                        <div className="row row-cols-1 row-cols-md-2">
                            <div className="col">
                                <img src="/imgs/my_fridge.png" className="score"/>
                            </div>
                            <div className="col">
                                <img src="/imgs/recipe_gen_1.png" className="score"/>
                            </div>
                        </div>
                        <div className="row row-cols-1 row-cols-md-2">
                            <div className="col">
                            ...
                            <div className="col">
                                <img src="/imgs/recipe_gen_2.png" className="score"/>
                            </div>
                        </div>
                    </div>
                </div>
