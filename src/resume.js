...
export function Resume() {
    return (
        <div>
            ...
            <main>
                <h1>Resume</h1>
                <p>Organized, collaborative, and punctual problem solver skilled in R, SQL, NoSQL, Python, JavaScript, HTML, CSS, Office, 
                ...
                <h2>Eductation</h2>
                <p>University of Washington - Bachelor of Science in Informatics</p>
                <p>Intellectual Foundations of Informatics, Foundational Skills for Data Science, Core Methods in Data Science, Advanced methods in Data Science, Databases and Data Modeling, Database Design and Management, Research Methods, Design Methods, Information Ethics and Policy, Introduction to Computer Programming, Interactive Information Visualization</p>
                <ul>
